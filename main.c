...
#define TOTAL_TEST 3000					/* set it up to 4,294,967,295 */
#define LOAD_DURITION 300 			/* set it in miliseconds */
#define UNLOAD_DURITION 1000		/* set it in miliseconds */
...
int main(void)
{
	...
	successMessage(int2char(currentTestNo));
...
int checkDevice(void)
{
	...
	delayMS(5); /* to prevent reading much earlier than output react */
